...
<div class ="container-fluid bg-light">
    <div class="signup-form bg-light">
        <form action="B_UserSignup.php" method="post">
            <h4>Welcome Business User</h4>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="_name" placeholder="Company name" required="required">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="email" class="form-control" name="_email" placeholder="Company email Address"
                        required="required">
                </div>
            </div>
            <div class="form-group">
