...
<div class ="container-fluid bg-light">
    <div class="signup-form bg-light">
        <form action="/E-Commerce/api/users.php" method="post">
            ...
            <div class="form-group">
                <button name="sign_up" type="submit" class="btn btn-primary btn-lg" >Sign Up</button>
            </div>
            Sign up as an Admin??<a href="../admin/Admin.php"> Click here</a><br>
            Own a business??<a href="../admin/B_User.php"> Get a business account</a>
    </div>
    </form>
