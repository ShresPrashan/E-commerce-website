...
<div id="productDetails">
    <div class="product-card">
        <nav>
            <a href="/E-Commerce/views/products.php" style="color:black;text-decoration:none">
        ...
        <div class="description">
            ...
            <form method="post" class="add_to_cart_form"
                action="/E-Commerce/config/cartSystem.php?action=add&id=<?php echo $productInfo["product_id"]; ?>">
