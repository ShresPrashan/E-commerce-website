<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar bg-dark collapse h-100">
        ...
        <ul class="nav flex-column" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="product-tab" data-toggle="tab" href="#product" role="tab"
                    aria-controls="product" aria-selected="false"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
